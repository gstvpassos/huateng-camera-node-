...
static const _SetFloat32_Request_type_support_symbol_names_t _SetFloat32_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, huateng_camera_node, srv, SetFloat32_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, huateng_camera_node, srv, SetFloat32_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, huateng_camera_node, srv, SetFloat32_Request)() {
  return &::huateng_camera_node::srv::rosidl_typesupport_c::SetFloat32_Request_message_type_support_handle;
}
...
static const _SetFloat32_Response_type_support_symbol_names_t _SetFloat32_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, huateng_camera_node, srv, SetFloat32_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, huateng_camera_node, srv, SetFloat32_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, huateng_camera_node, srv, SetFloat32_Response)() {
  return &::huateng_camera_node::srv::rosidl_typesupport_c::SetFloat32_Response_message_type_support_handle;
}
...
static const _SetFloat32_type_support_symbol_names_t _SetFloat32_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, huateng_camera_node, srv, SetFloat32)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, huateng_camera_node, srv, SetFloat32)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, huateng_camera_node, srv, SetFloat32)() {
  return &::huateng_camera_node::srv::rosidl_typesupport_c::SetFloat32_service_type_support_handle;
}
