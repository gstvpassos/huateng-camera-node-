...
#include "huateng_camera_node/srv/detail/set_float32__rosidl_typesupport_fastrtps_c.h"
...
#include "huateng_camera_node/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SetFloat32_Request__ros_msg_type = huateng_camera_node__srv__SetFloat32_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_huateng_camera_node
size_t get_serialized_size_huateng_camera_node__srv__SetFloat32_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetFloat32_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_huateng_camera_node__srv__SetFloat32_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_huateng_camera_node
size_t max_serialized_size_huateng_camera_node__srv__SetFloat32_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = huateng_camera_node__srv__SetFloat32_Request;
    is_plain =
      (
...
static size_t _SetFloat32_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_huateng_camera_node__srv__SetFloat32_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, huateng_camera_node, srv, SetFloat32_Request)() {
...
using _SetFloat32_Response__ros_msg_type = huateng_camera_node__srv__SetFloat32_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_huateng_camera_node
size_t get_serialized_size_huateng_camera_node__srv__SetFloat32_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetFloat32_Response__ros_msg_type * ros_message = static_cast<const _SetFloat32_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_huateng_camera_node__srv__SetFloat32_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_huateng_camera_node
size_t max_serialized_size_huateng_camera_node__srv__SetFloat32_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = huateng_camera_node__srv__SetFloat32_Response;
    is_plain =
      (
...
static size_t _SetFloat32_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_huateng_camera_node__srv__SetFloat32_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, huateng_camera_node, srv, SetFloat32_Response)() {
...
// already included above
// #include "huateng_camera_node/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "huateng_camera_node/srv/set_float32.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, huateng_camera_node, srv, SetFloat32)() {
